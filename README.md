# UABankPay.js
[![GitHub License](https://img.shields.io/github/license/sirkadirov/uabankpay.js)](https://github.com/sirkadirov/uabankpay.js/blob/main/LICENSE)
...
## Usage
To use UABankPay, you need to install it first. You can do this using `npm`:

```bash
npm install @sirkadirov/uabankpay
```

Then, you can import the library and create an instance of the `UABankPay` class:

```javascript
import UaBankPayProvider from '@sirkadirov/uabankpay';
```

You can then use the `generatePayLink` method to create a payment link.
